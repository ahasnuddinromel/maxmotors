                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="mb-3 row">
                                                <label for="example-tel-input" class="col-md-3 col-form-label">Logo</label>
                                                <div class="col-md-9">
                                                    <input name="business_logo"  class="form-control" type="file" id="example-tel-input">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <div class="col-md-12">
                                                    <input class="form-control btn btn-outline-danger" type="submit" value="Add Business Info">
                                                </div>
                                            </div>
