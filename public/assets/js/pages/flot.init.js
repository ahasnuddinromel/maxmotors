  ...
  t.prototype.createPlotGraph = function (t, a, o, e, r, l, i, s) {
    n.plot(n(t),
      ...
      }],
      {
        ...
        yaxis: {
          min: 0, max: 300, tickColor: "rgba(166, 176, 207, 0.1)",
          font: { color: "#9295a4" }
        },
        xaxis: {
    ...
    for (0 < this.$realData.length && (this.$realData = this.$realData.slice(1));
      ...
      var t = (0 < this.$realData.length ? this.$realData[this.$realData.length - 1] : 50) + 10 * Math.random() - 5; t < 0 ? t = 0 : 100 < t && (t = 100),
    ...
    this.createPlotGraph("#website-stats",
      [[0, 50], [1, 130], [2, 80], [3, 70], [4, 180], [5, 105], [6, 250]], [[0, 80], [1, 100], [2, 60], [3, 120], [4, 140], [5, 100], [6, 105]], [[0, 20], [1, 80], [2, 70], [3, 140], [4, 250], [5, 80], [6, 200]],
      ["Desktops", "Laptops", "Tablets"], ["#f0f1f4", "#5b73e8", "#f1b44c"],

      "rgba(166, 176, 207, 0.1)", "transparent");
    this.createPieGraph("#pie-chart #pie-chart-container",
      ["Desktops", "Laptops", "Tablets"],
      [20, 30, 15],
      ["#5b73e8", "#f1b44c", "#ebeff2"]);
    var a = this.createRealTimeGraph("#flotRealTime",
      this.randomData(),
      ["#34c38f"]);
    a.draw();
    var o = this; !function t() {
      a.setData([o.randomData()]), a.draw(),
...
}(window.jQuery), function () { "use strict"; window.jQuery.FlotChart.init() }();